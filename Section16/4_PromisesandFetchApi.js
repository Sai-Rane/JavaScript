//Now lets see the modern way of making AJAX calls. For this we use the Fetch API
...
//What is promise - A container for an asynchronous delivered value OR A container for a future value(Example of future value is response coming from a AJAX call)
